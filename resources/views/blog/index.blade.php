...
<x-app-layout>
   ...
   <div class="flex justify-between items-center bg-slate-700 p-3 px-[2.5%]">
    <h1 class="font-bold text-blue-200 ">Blogs</h1>
    ...
    <a href="{{ route('admin.blog.create') }}" class="text-white  focus:outline-none focus:ring-4 font-medium rounded-full text-sm px-5 py-2.5 text-center border border-yellow-500 hover:bg-yellow-600">Create</a>
   </div>
  </x-slot>

    <div class="w-[90%] mx-auto mt-7">
        {{-- <form action="{{ route('admin.blog.index') }}" method="get" class="flex gap-3 my-3">
              ...
              <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                ...
                @forelse ($blogs as $blog)
                    <tr class="bg-white dark:bg-gray-800 hover:bg-gray-700 dark:hover:bg-gray-700">
                        <td class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $blog->title }}</td>
                        <td class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $blog->created_at }}</td>
                        <td class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $blog->status }}</td>
