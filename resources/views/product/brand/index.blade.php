...
@section('content')
<div x-data="data()" class="mt-4 pb-[50px] w-full sm:w-10/12 mx-auto">
   <div class="flex justify-between items-center mb-2">
       ...
       <a href="{{ route('admin.product.brand.create') }}"
        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                <tr id="{{ $item->id }}"
                    ...
                    <td scope="row" class="px-6 py-[15px] font-medium text-gray-900 dark:text-white whitespace-nowrap">
                        <img class="max-w-[110px] max-h-[60px]" src="{{ $item->image }}" alt="">
                    </td>
                    <td class="px-6 py-4 ">
                    ...
                    <td class="px-6 py-[30px] w-fit flex items-center">
                        ...
                        <a href="{{ route('admin.product.brand.edit',['id' => $item->id]) }}" class="inline-block bg-primary mx-1  p-1 rounded-sm">
    ...
    <div x-cloak x-show="modalIsOpen" class="fixed top-0 left-0 w-full h-screen bg-[rgba(0,0,0,.8)] z-50">
        ...
        const data = () => {
            return {
                ...
                activate: function (id)  {
                    ...
                    axios.post('{{ route("admin.product.brand.activate") }}', {
                        id
                    })
                    .then(res => {
                ...
                remove: function (id)  {
                    ...
                    axios.post('{{ route("admin.product.brand.delete") }}', {
                        id
                    })
                    .then(res => {
                        console.log(res);
                ...
                show: function(type,id) {
                    this.loading =true;
                    axios.post('{{ route("admin.product.brand.show") }}', {
                        type,
                        id
                    })
                    .then(res => {
