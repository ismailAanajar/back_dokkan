...
@section('content')
<div x-data="createBrand()" class="relative p-1">
    
    <form @submit.prevent="updateBrand" class="flex flex-wrap w-11/12 mt-14 mx-auto gap-5">
     ...
     const createBrand = () => {
            return {
                ...
                updateBrand(e) {
                    e.preventDefault();
                    this.loading = true;
                    axios.post('/admin/product/brand/store', new FormData(document.querySelector('form')))
                        .then(res => {
                            console.log(res);
                            this.loading = false;
                            Toastify({
